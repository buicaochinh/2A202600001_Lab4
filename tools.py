...
def search_hotels(city: str, max_price_per_night: int = 99999999) -> str:
    ...
    result = f"Khách sạn tại {city} (giá dưới {max_price_per_night:,}đ/đêm):"
    for h in filtered_hotels:
        result += (
            f"- {h['name']}: {h['stars']} sao | {h['price_per_night']}/đêm | "
...
def calculate_budget(total_budget: int, expenses: str) -> str:
    ...
    try:
        ...
        for item in expenses.split(","):
            ...
            expenses_dict[key.strip()] = int(value.strip())
        ...
        return f"Lỗi khi tính toán ngân sách: {str(e)}. Vui lòng kiểm tra lại định dạng expenses."
